...
public class ArcMenu extends FrameLayout {
    ...
    public static final int ANIMATION_DURATON = 300;
    ...
    private void init(Context context) {
        ...
        controlLayout.setOnTouchListener(new OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                if (event.getAction() == MotionEvent.ACTION_DOWN && mArcLayout.isExpanded() && !mArcLayout.isAnimating()) {
        ...
        mArcLayout.setHintView(mHintView);
    }
    ...
    public void clearItems() {
    	if(mArcLayout.getChildCount() != 0) {
    		mArcLayout.removeAllViews();
    	}
    }
    
    public void setHintViewSize(int size) {
        FrameLayout.LayoutParams lp = (FrameLayout.LayoutParams) mHintView.getLayoutParams();
    ...
    private OnClickListener mOnClickListener = new OnClickListener() {
		...
		public void onClick(final View viewClicked) {
            Animation animation = bindItemAnimation(viewClicked, true, ANIMATION_DURATON);
            ...
            for (int i = 0; i < itemCount; i++) {
                ...
                if (viewClicked != item) {
                    bindItemAnimation(item, false, ANIMATION_DURATON);
                }
            }
    ...
    public void setOnCallbackListener(OnCallbackListener listener) {
    	mListener = listener;
    	mArcLayout.setOnCallbackListener(listener);
    }
    
    public ArcLayout getLayout() {
    	return mArcLayout;
    }
	...
	public boolean dispatchKeyEvent(KeyEvent event) {
		...
		if(event.getKeyCode() == KeyEvent.KEYCODE_BACK 
				...
				&& mArcLayout.isExpanded() && !mArcLayout.isAnimating()) {
            mHintView.startAnimation(createHintSwitchAnimation(mArcLayout.isExpanded()));
			mArcLayout.switchState(true);
			return false;
		}
